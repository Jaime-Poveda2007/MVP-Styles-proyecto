// src/features/marcas/NavMarcasPanel.tsx
...
export type MarcasPanelStackParamList = {
  Catalogo: undefined;
...
const Stack = createNativeStackNavigator<MarcasPanelStackParamList>();
...
export default function NavMarcasPanel({ marcaId, onCerrarSesion }: Props) {
  return (
